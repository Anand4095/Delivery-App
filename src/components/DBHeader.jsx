  ...
  return (
    <div className='w-full flex items-center justify-between gap-3'>
        <p className='text-2xl text-headingColor'>
            Welcome to City
            { user.data.email && (
                <span className='block text-base text-gray-500'>{`Hello ${user?.data?.email}...!`}</span>
            )}
        </p>

        <div className='flex items-center justify-center gap-4'>
                <div className='felx items-center justify-center gap-3 px-4 py-2
                ...
                <div className='flex items-center justify-center gap-2'>
                    <div className='w-10 h-10 rounded-md shadow-md cursor-pointer
                    overflow-hidden'>
                        <motion.img 
