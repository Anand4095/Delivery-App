...
const DBNewItem = () => {
  ...
  const submitNewData = () => {
    ...
    addNewProduct(data).then((res) => {
      ...
      dispatch(alertSuccess("New Itme added"));
      setTimeout(() => {
        dispatch(alertNULL());
      }, 3000);
      setImageDownloadURL(null);
  ...
  return (
    <div className='flex items-center justify-center flex-col pt-6 px-24 w-full'>
        <div className='border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4'>
          ...
          <div className='w-full bg-card backdrop-blur-md h-370 rounded-md border-2
          ...
          <motion.button
            ...
            {...buttonClick}
            className='w-9/12 py-2 rounded-md bg-red-400 text-primary
