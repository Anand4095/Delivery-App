            ...
            onClick={() => dispatch(setCartOn())}
             className="relative cursor-pointer">
                 ...
                 {cart?.length > 0 && (
                    ...
                    justify-center absolute -top-4 -right-4">
            ...
            {user ? (
                        ...
                        {...slideTop}
                         ...
                         flex flex-col gap-4">
                             ...
                             <motion.div 
                                 {...buttonClick}
                                 onClick={signOut}
                                 className="group flex items-center justify-center px-3 py-2 rounded-md
                                 shadow-md bg-gray-100 hover:bg-gray-200 gap-3"
                             >
                                 <MdLogout className="text-2xl text-textColor
                                 group-hover::text-headingColor"/>
                                 <p className="text-textColor text-xl 
                                 group-hover::text-headingColor">Sign Out</p>
                             </motion.div>
                         </motion.div>
                       )}
                    </div>
                ...
                <>
                    <NavLink to={"/login"}>
                        <motion.button
                            {...buttonClick}
                            className="px-4 py-2 rounded-md shadow-md bg-lightOverlay
