     ...
     {/* Background Image */}
        ...
        {/* content box */}
            <div className='flex flex-col items-center
             bg-lightOverlay w-[28%] md:508 h-full z-10
             backdrop-blur-md p-4 px-4 py-12 gap-6'>
                ...
                {/* welcome text */}
                    ...
                    <p className='text-xl text-textColor -mt-6'>
                        {isSignUp ? "SignUp" : "SignIn"} with following</p>
                ...
                <div className='w-full flex flex-col items-center justify-center gap-6 px-4 md:px-12 py-4'>
                   ...
                   {isSignUp ? (
                        <motion.button 
                         {...buttonClick}
                         className = "w-full px-4 py-2 rounded-md bg-red-400 cursor-pointer text-white text-xl capitalize hover:bg-red-500 transition-all duration-75"
